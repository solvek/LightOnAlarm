...
package com.solvek.lightonalarm.feature.lightonalarm.ui.lightonalarm
...
class LightOnAlarmViewModelTest {
    @Test
    fun uiState_initiallyLoading() = runTest {
        val viewModel = LightOnAlarmViewModel(FakeLightOnAlarmRepository())
        assertEquals(viewModel.uiState.first(), LightOnAlarmUiState.Loading)
    }
